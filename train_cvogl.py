...
from sample4geo.dataset.cvogl import CVOGLDatasetEval, CVOGLDatasetTrain
...
class Configuration:
    ...
    model_path: str = "./pretrained/cvogl"
...
if __name__ == '__main__':
    ...
    if config.sim_sample:
        ...
        query_dataset_train = CVOGLDatasetEval(data_folder=config.data_folder,
                                               data_name=config.data_name,
                                               split="train",
                                               img_type="query",   
                                               transforms=ground_transforms_val)
