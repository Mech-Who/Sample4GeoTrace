# 不知道为什么，from torch.utils.data import Dataset  
# 必须放在 import cv2 之前
import torch
...
class CVACTDatasetTest(Dataset):
    ...
    def __init__(self,
        ...
        files_ground = glob(f'{self.data_folder}/ANU_data_test/streetview/*_grdView.jpg') # 有问题：本人缺少/CVACT/ANU_data_test/streetview文件
