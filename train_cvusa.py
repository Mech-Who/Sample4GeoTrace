...
class Configuration:
    ...
    # gps_dict_path: str = "/hong614/dataset/CVUSA/gps_dict.pkl"   # path to pre-computed distances
    ...
    data_folder = "/data1/zhangqingwang/dataset/CVUSA"     
...
if __name__ == '__main__':
    ...
    pretrained_cfg_overlay = {'file' : r"/home/lingxingtao/.cache/torch/hub/checkpoints/convnext_base.bin"}
