...
class Configuration:
    ...
    gps_dict_path: str = "/hong614/dataset/CVACT/gps_dict.pkl"   # path to pre-computed distances
    ...
    # Dataset
    data_folder = "/hong614/dataset/CVACT"     
...
if __name__ == '__main__':
    ...
    pretrained_cfg_overlay = {'file' : r"/root/.cache/torch/hub/checkpoints/pytorch_model.bin"}
